...
VBoxManage modifyvm Fedora64_Build --memory 4048 --cpus 2 --nic1 nat
VBoxManage createhd --filename ~/VirtualBox\ VMs/Fedora64_Build/Fedora64_Build.vdi --size 15000
...
VBoxManage modifyvm Fedora64_Registry --memory 4048 --cpus 2 --nic1 nat
VBoxManage createhd --filename ~/VirtualBox\ VMs/Fedora64_Registry/Fedora64_Registry.vdi --size 15000
...
VBoxManage modifyvm Fedora64_Containers --memory 4048 --cpus 2 --nic1 nat
VBoxManage createhd --filename ~/VirtualBox\ VMs/Fedora64_Containers/Fedora64_Containers.vdi --size 15000
